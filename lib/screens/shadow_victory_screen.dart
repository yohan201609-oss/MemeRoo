...
class ShadowVictoryScreen extends StatefulWidget {
  final int score;
  final int correctAnswers;
  final int totalRounds;
  final String level;

  const ShadowVictoryScreen({
    super.key,
    required this.score,
  ...
  @override
  State<ShadowVictoryScreen> createState() => _ShadowVictoryScreenState();
}

class _ShadowVictoryScreenState extends State<ShadowVictoryScreen> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    if (GameConstants.getNextLevel(widget.level) != null)
                      _buildButton(
                        ...
                        () {
                          ...
                          context.read<ShadowProvider>().initializeGame(nextLevel);
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const ShadowGameScreen(),
                            ),
                          );
                        },
                      )
                    ...
                    _buildButton(
                      ...
                      Colors.orange,
                      () {
                        context.read<ShadowProvider>().resetGame();
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const ShadowGameScreen(),
