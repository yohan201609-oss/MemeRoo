...
class SequenceHomeScreen extends StatefulWidget {
  const SequenceHomeScreen({super.key});

  @override
  State<SequenceHomeScreen> createState() => _SequenceHomeScreenState();
}

class _SequenceHomeScreenState extends State<SequenceHomeScreen> {
  @override
                      ...
                      child: Column(
                        children: [
                          _buildLevelButton(
                            ...
                            level: 'easy',
                            title: 'Fácil',
                            subtitle: 'Llega a 5 rondas\nRécord: ${snapshot.data?['easy_score'] ?? 0}',
                          ...
                          _buildLevelButton(
                            ...
                            level: 'medium',
                            title: 'Medio',
                            subtitle: 'Llega a 7 rondas\nRécord: ${snapshot.data?['medium_score'] ?? 0}',
                          ...
                          _buildLevelButton(
                            ...
                            level: 'hard',
                            title: 'Difícil',
                            subtitle: 'Llega a 10 rondas\nRécord: ${snapshot.data?['hard_score'] ?? 0}',
  ...
  Future<Map<String, int>> _getStars() async {
    ...
    return {
      ...
      'easy_score': prefs.getInt('sequence_highscore_easy') ?? 0,
      'medium_score': prefs.getInt('sequence_highscore_medium') ?? 0,
      'hard_score': prefs.getInt('sequence_highscore_hard') ?? 0,
    };
  }
